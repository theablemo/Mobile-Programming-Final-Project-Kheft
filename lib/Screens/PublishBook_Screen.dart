                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(bottom: 5),
                            child: CustomTextInput(
                              textHint: selectedPublicationDate == null
                                  ? "Publication"
                                  : DateFormat.yMMMd()
                ...
                children: [
                  Expanded(
                    child: CustomSubmitButton(
                      doOnPressed: () {
                        if (images.isEmpty ||
                            titleTextInput.text.isEmpty ||
                            writerTextInput.text.isEmpty ||
                            publisherTextInput.text.isEmpty ||
                            selectedPublicationDate == null ||
                            priceTextInput.text.isEmpty) {
                          showErrorDialog(
                              context, "Please fillout all necessary fields.");
                        } else {
                          showDialog(
                              useSafeArea: true,
                          ...
                          addBook(
                                  44,
                                  titleTextInput.text,
                                  int.parse(priceTextInput.text),
                                  publisherTextInput.text,
                                  writerTextInput.text,
                                  (selectedPublicationDate!
                                              .millisecondsSinceEpoch /
                                          1000)
                                      .toInt(),
                                  exchange ? [exchangeBookTitle.text] : [],
                                  images)
                              .then((value) {
                            Navigator.of(context).pop();
                            Navigator.of(context).pop();
                            showErrorDialog(context,
                                "Book ${titleTextInput.text} has been published.");
                          });
                        }
                      },
                      icon: Icons.publish,
